  ...
  ({ className, type, ...props }, ref) => {
    ...
    return (
      <input
        type={type}
        className={cn(
          "flex h-11 w-full rounded-[18px] border border-[hsl(214_40%_80%/.58)] bg-[linear-gradient(180deg,hsl(0_0%_100%/.62),hsl(210_100%_97%/.34))] px-4 py-2 text-base text-[hsl(221_38%_34%)] shadow-[inset_0_1px_0_rgba(255,255,255,0.86),0_10px_22px_rgba(53,108,196,0.08)] backdrop-blur-xl ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-[hsl(221_38%_34%)] placeholder:text-[hsl(219_24%_62%)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm dark:border-[var(--glass-stroke-soft)] dark:bg-[linear-gradient(180deg,hsl(220_28%_100%/.12),hsl(220_28%_100%/.05))] dark:text-foreground dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.12),0_14px_28px_rgba(2,8,23,0.18)] dark:file:text-foreground dark:placeholder:text-muted-foreground/90",
          hasValue
